...
import pandas as pd
from main_window.bottom_frame.personal_account_view.bottom_frame.z_utility.image_drop import InteractiveDropArea
from main_window.mySQL.SqlModel import (insert_or_update_zone_with_screenshot, get_zone_scores, get_all_screenshots)
