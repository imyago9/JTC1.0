...
from main_window.bottom_frame.personal_account_view.bottom_frame.account_information_view.three_graph_view.calendar_graph_view.CalendarGraphViewModel import \
    CalendarViewModel
