...
from main_window.bottom_frame.personal_account_view import PersonalAccountView
from utils import ResourceLoader as RL, load_stylesheet

from main_window.bottom_frame.personal_account_view.PersonalAccountModel import PersonalAccountModel
