...
import pandas as pd
from old_version.main_window.bottom_frame.personal_account_view.bottom_frame.z_utility.image_drop import InteractiveDropArea
from old_version.main_window.mySQL.SqlModel import (insert_or_update_zone_with_screenshot, get_zone_scores, get_all_screenshots)
    ...
    def setupInputs(self):
        try:
            ...
            for label in ['HTF', 'ITF', 'LTF']:
                ...
                self.screenshot_layout.setStretchFactor(self.screenshot_areas[label], 1)
