...
from login_executable.user_database.AuthService import AuthService
from utils import resource_path, load_stylesheet, show_message
...
class LoginViewModel(QObject):
    ...
    def open_main_window_view(self):
        try:
            from main_window.main import execute_app
